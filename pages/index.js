...
.version-stamp {
  ...
  return (
    <>
      <Head>
        <title>Apisku - REST API Documentation</title>
        <meta name="title" content="Apisku - REST API Documentation" />
        <meta name="description" content="Apisku is a free, simple REST API created by Siputzx for the common good. Feel free to use it, but please avoid DDoS attacks." />
        <meta name="keywords" content="REST API, Apisku, Siputzx, Qanypaw, Nawdev, Itzpire API, free API, API documentation, bot wa, free REST API" />
        <meta name="robots" content="index, follow" />
        <meta httpEquiv="Content-Type" content="text/html; charset=utf-8" />
        <meta name="language" content="English, Indonesian" />

        {/* Open Graph Meta Tags */}
        <meta property="og:title" content="Apisku - REST API Documentation" />
        <meta property="og:description" content="Apisku is a free, simple REST API created by Siputzx for the common good. Feel free to use it, but please avoid DDoS attacks." />
        <meta property="og:url" content="https://apisku.biz.id" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://i.ibb.co/TbKCyLg/dbb0b7dc-3dd8-4a77-adec-e2ef8d555fee.jpg" />

        {/* Twitter Meta Tags */}
        <meta name="twitter:title" content="Apisku - REST API Documentation" />
        <meta name="twitter:description" content="Apisku is a free, simple REST API created by Siputzx for the common good. Feel free to use it, but please avoid DDoS attacks." />
        <meta name="twitter:image" content="https://i.ibb.co/TbKCyLg/dbb0b7dc-3dd8-4a77-adec-e2ef8d555fee.jpg" />
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebSite",
            "name": "Apisku",
            "url": "https://apisku.biz.id",
            "description": "Apisku is a free, simple REST API created by Siputzx for the common good. Feel free to use it, but please avoid DDoS attacks.",
            "sameAs": [
